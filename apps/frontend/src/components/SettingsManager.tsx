...
export const SettingsManager: React.FC = () => {
  ...
  return (
    <div className="p-6 max-w-4xl w-full mx-auto grid grid-cols-1 md:grid-cols-4 gap-6 text-slate-700 font-sans">
        ...
        <form onSubmit={handleSaveSettings} className="space-y-6">
          {activeTab === 'profile' && (
            <div className="bg-white border border-slate-200 rounded-2xl p-6  space-y-4">
              <h3 className="text-xs font-bold text-slate-700 uppercase tracking-wider flex items-center gap-1.5"><User className="w-4 h-4 text-emerald-400" /> Account Profile</h3>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="block w-full h-10 px-3.5 bg-white border border-slate-200 rounded-xl text-xs text-white placeholder-slate-400 focus:outline-none focus:border-emerald-500/50"
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    value={email}
                    disabled
                    className="block w-full h-10 px-3.5 bg-white border border-slate-200 rounded-xl text-xs text-slate-500 cursor-not-allowed"
                  />
                </div>
              </div>
              
              <div className="text-[10px] bg-slate-50 p-3 rounded-xl border border-slate-850 text-slate-500">
          ...
          {activeTab === 'provider' && (
            <div className="bg-white border border-slate-200 rounded-2xl p-6  space-y-4">
              <h3 className="text-xs font-bold text-slate-700 uppercase tracking-wider flex items-center gap-1.5"><Cpu className="w-4 h-4 text-emerald-400" /> AI Provider Configuration</h3>
              
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label className="block text-[10px] font-bold text-slate-500 uppercase tracking-wider mb-1.5">Default Generator Engine</label>
                  <select 
                ...
                <div>
                  <label className="block text-[10px] font-bold text-slate-500 uppercase tracking-wider mb-1.5">Default Content Tone</label>
                  <select 
                    value={defaultTone}
              ...
              <div className="space-y-3.5 pt-2">
                <span className="text-[10px] font-bold text-slate-500 uppercase tracking-wider block flex items-center gap-1.5"><Key className="w-3.5 h-3.5 text-emerald-400" /> Custom API Keys (optional overrides)</span>
                <div>
                  ...
                  <input
                    ...
                    placeholder="sk-proj-..."
                    className="block w-full h-10 px-3.5 bg-white border border-slate-200 rounded-xl text-xs text-white placeholder-slate-700 focus:outline-none"
                  />
                </div>
                <div>
          ...
          {activeTab === 'preferences' && (
            <div className="bg-white border border-slate-200 rounded-2xl p-6  space-y-4">
              <h3 className="text-xs font-bold text-slate-700 uppercase tracking-wider flex items-center gap-1.5"><Globe className="w-4 h-4 text-emerald-400" /> Regional & Display Preferences</h3>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <select 
                    ...
                    className="w-full bg-white border border-slate-200 rounded-lg px-3 py-2.5 text-xs text-white focus:outline-none"
                  >
          ...
          {activeTab === 'notifications' && (
            <div className="bg-white border border-slate-200 rounded-2xl p-6  space-y-4">
              <h3 className="text-xs font-bold text-slate-700 uppercase tracking-wider flex items-center gap-1.5"><Bell className="w-4 h-4 text-emerald-400" /> Notifications & Interface</h3>
              ...
              <div className="space-y-3.5 text-xs">
                <div className="flex items-center justify-between">
                  ...
                  <input 
                    ...
                    className="h-4.5 w-4.5 bg-white border border-slate-200 rounded text-emerald-600 focus:ring-emerald-500/40" 
                  />
                </div>
          ...
          {activeTab === 'danger' && (
            <div className="bg-white border border-red-500/20 bg-red-500/5 rounded-2xl p-6  space-y-4">
              ...
              <div className="space-y-4">
                <div className="p-4 bg-slate-50 border border-slate-850 rounded-xl flex items-center justify-between gap-4 flex-wrap">
                  <div>
                  ...
                  <button 
                    ...
                    className="px-3.5 py-1.5 rounded-lg bg-slate-50 border border-slate-200 hover:bg-slate-850 text-slate-700 font-bold text-xs flex items-center gap-1"
                  >
